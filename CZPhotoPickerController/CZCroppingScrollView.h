...
@interface CZCroppingScrollView : UIScrollView

@property(nonatomic,readonly) UIImage *croppedImage;

/**
 `cropSize` should be the desired aspect ratio in screen size.
 The `cropSize` can be CGSizeZero to display the full image without
 the ability to move & scale.
*/
