Pod::Spec.new do |s|
  s.name         = "Kwarter-CZPhotoPickerController"
  s.version      = "1.1"
  s.summary      = "A photo picker offering 'use last photo taken', 'take photo', and 'choose from library'."
  s.homepage     = "https://github.com/kwarter/Kwarter-CZPhotoPickerController"
  s.license      = "Apache 2.0"
  s.authors      = { "Brian Cooke" => "brian@carezone.com", "Peyman Oreizy" => "peyman@carezone.com" }
  s.source       = { :git => "https://github.com/kwarter/Kwarter-CZPhotoPickerController.git", :tag => "1.1" }
  s.platform     = :ios, '5.0'
